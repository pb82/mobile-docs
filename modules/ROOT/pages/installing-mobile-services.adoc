...
* link:https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html[Ansible] version 2.3 or later
...
****
You can download Docker CE for Linux version 17.09.1 link:https://download.docker.com/linux/centos/7/x86_64/stable/Packages/docker-ce-17.09.1.ce-1.el7.centos.x86_64.rpm[here].
****
...
+
Once completed successfully, this will end with output similar to:
+
----
